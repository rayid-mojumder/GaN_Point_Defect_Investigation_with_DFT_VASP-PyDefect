...
```
The above two codes will open .pmgrc.yaml file. Now, add the functional type, POTCAR directory, and materials project API in the text file and save it.
[This is not bash commad]. For instance, my info is -
```
