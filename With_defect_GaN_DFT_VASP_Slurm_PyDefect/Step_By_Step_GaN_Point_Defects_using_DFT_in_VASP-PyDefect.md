...
* I am using Slurm to run the package in the remote server; if you are using MPIrun or other, please adjust the VASP run scripts. Either way, you can follow this guide.
